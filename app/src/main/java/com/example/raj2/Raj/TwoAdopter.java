...
public class TwoAdopter extends RecyclerView.Adapter<TwoAdopter.ViewHolder> {

    public TwoAdopter(Context contet, ArrayList<Twomodel> twomodels) {
