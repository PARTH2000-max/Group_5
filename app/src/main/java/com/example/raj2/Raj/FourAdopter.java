...
public class FourAdopter extends RecyclerView.Adapter<FourAdopter.ViewHolder> {

    public FourAdopter(Context context, ArrayList<Twomodel> twomodels) {
